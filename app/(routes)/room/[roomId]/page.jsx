  ...
  if (!name) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-2xl border border-indigo-500/40 bg-black/50 backdrop-blur-md">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-sky-200">
              Loading Lobby...
            </CardTitle>
          </CardHeader>
          <CardContent className="text-center text-indigo-100/80">
            <p>Please wait while we spray some pixels on the wall.</p>
          </CardContent>
        </Card>
      </div>
    );
    ...
    <div className="min-h-screen p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 text-center">
          <h1
            className="title-graffiti text-3xl md:text-4xl font-extrabold text-sky-300 mb-3 drop-shadow-[0_0_25px_rgba(56,189,248,0.9)] cursor-pointer"
            onClick={handleCopy}
          >
            Pixel Party Room: {roomId}
          </h1>
